...
vi.mock("@/features/collections/list/components/CollectionsPage", () => ({
  CollectionsPage: () => <div>Collections workspace</div>,
}));
vi.mock("@/features/review/components/ReviewRouteWorkspace", () => ({
  ReviewRouteWorkspace: () => <div>Review workspace</div>,
}));
