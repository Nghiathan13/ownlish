...
import { REFRESH_COOKIE_NAME } from "@/_app/api-routes/auth/lib/constants";

const { postUpstreamAuthMock } = vi.hoisted(() => ({
  postUpstreamAuthMock: vi.fn(),
}));

vi.mock("@/_app/api-routes/auth/lib/upstreamAuth", () => ({
...
import {
  ...
  handlePublicAuth,
} from "@/_app/api-routes/auth/lib/handleCredentialAuth";
