...
export const testOverviewCardClassName =
  "flex flex-col gap-4 rounded-[20px] bg-surface p-4 shadow-card";
...
export const testOverviewMockButtonClassName = iconTextButtonClassName(
  "flex-1 rounded-[4px] border-border bg-transparent text-foreground hover:bg-hover-overlay",
);

export const testOverviewPracticeButtonClassName = iconTextButtonClassName(
  "flex-1 rounded-[4px] border-foreground bg-foreground text-background hover:[box-shadow:inset_0_0_0_9999px_var(--hover-overlay-solid)]",
);
