...
export const testOverviewCardClassName =
  "flex flex-col gap-4 rounded-[36px] bg-surface px-4 py-5 shadow-card";
...
export const testOverviewMockButtonClassName = iconTextButtonClassName(
  "flex-1 rounded-[20px] border-4 border-border bg-transparent text-foreground hover:bg-hover-overlay",
);

export const testOverviewPracticeButtonClassName = iconTextButtonClassName(
  "flex-1 rounded-[20px] border-4 border-foreground bg-foreground text-background hover:[box-shadow:inset_0_0_0_9999px_var(--hover-overlay-solid)]",
);
