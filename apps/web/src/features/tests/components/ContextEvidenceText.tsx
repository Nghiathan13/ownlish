...
const evidenceBadgeClassName =
  "mr-1 inline-flex h-[1em] min-w-[1em] shrink-0 items-center justify-center align-middle rounded px-0.5 text-[0.625rem] font-semibold leading-none tabular-nums text-amber-800 ring-1 ring-amber-300/70 bg-amber-50 dark:text-amber-300 dark:ring-amber-700/60 dark:bg-amber-950/60";
