import type { DifficultReviewWord } from "@/entities/review";
          ...
          >
            <div className="grid">
              {words.map((item, index) => (
                <div
                  className={`${difficultTableGridClassName} border-b border-border px-2 py-2 text-sm hover:bg-hover-overlay`}
