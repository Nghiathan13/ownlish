...
import { ProgressNavIcon } from "@/shared/ui/icons";
import { ReviewNavIcon } from "@/shared/ui/icons";

const vocabCardClassName =
  "group flex min-w-[300px] flex-col rounded-2xl border border-border bg-surface p-5 sm:p-6";
  ...
  return (
    <article className={vocabCardClassName}>
      ...
      <button
        ...
        className="mt-5 flex min-h-[16rem] w-full flex-1 cursor-pointer flex-col content-center justify-center gap-6 border-0 bg-transparent p-0 text-center font-inherit"
