...
import { useMockTestHistory } from "../model/useMockTestHistory";
import { areAllPartsSelected } from "@/entities/toeic-runtime";
          ...
          <div className="flex flex-col gap-4">
            ...
            {history.isLoading ? (
              ...
              items.map((item) => {
                ...
                return (
                <article
                  className="flex min-w-0 flex-col gap-4 rounded-card border border-border bg-surface-card p-4 hover:border-primary"
                  key={item.sessionId}
                >
