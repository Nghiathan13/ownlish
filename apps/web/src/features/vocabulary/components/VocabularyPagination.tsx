    ...
    <div className="flex flex-wrap items-center gap-3">
      ...
      <div className="flex flex-wrap items-center gap-2 text-sm text-muted-foreground">
        <select
          ...
          className="page-size-select h-7 w-fit min-w-0 cursor-pointer appearance-none rounded-md border border-border bg-surface px-2.5 text-sm text-foreground outline-none transition-[width,border-color] duration-200 [field-sizing:content] hover:border-foreground focus:border-foreground [@media(prefers-color-scheme:dark)]:color-scheme-dark"
          value={pageSize}
          onChange={(event) => {
  ...
  return (
    <button
      ...
      className={classNames(
        "inline-flex size-7 items-center justify-center rounded-md border border-border bg-surface text-foreground transition-colors duration-200",
        disabled
