...
import { PracticeStepContent } from "@/features/test-study/ui/PracticeStepContent";
import { PracticeContinuousShell } from "@/features/test-study/ui/PracticeContinuousShell";
import { PracticeNavigationButtons } from "@/features/test-study/ui/PracticeNavigationButtons";
import {
  TestRunLoadingSkeleton,
  type TestRunLoadingVariant,
} from "@/features/test-study/ui/TestRunLoadingSkeleton";
import { usePracticeSession } from "@/features/test-study/model/practice/usePracticeSession";
import type { PracticeMode, ToeicQuestionGroup } from "@/entities/toeic-runtime";
import {
  buildPracticeRunSteps,
} from "@/features/test-study/lib/practiceRunSteps";
import {
  readTestPracticeGroupKey,
  writeTestPracticeGroupKey,
} from "@/entities/toeic-runtime";
import { resolveInitialTestPracticeStepIndex } from "@/features/test-study/model/practice/testPracticeStepPosition";
import {
  getQuestionGridResultFromAnswer,
  isQuestionGridSelected,
} from "@/features/test-study/lib/practiceAnswers";
import {
  buildPracticeRunGridSections,
  findStepIndexForQuestionId,
  getActiveQuestionIdsForStep,
} from "@/features/test-study/lib/practiceQuestionGrid";
import {
  getSessionQuestionNumber,
} from "@/features/test-study/lib/sessionQuestionPosition";
import { normalizeSelectedParts } from "@/entities/toeic-runtime";
import { useRegisterImmersiveExit } from "@/shared/lib/providers";
import {
