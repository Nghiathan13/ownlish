...
import type { PassageTableRow } from "@/features/test-study/lib/passageContent.types";
import { getTableColumnStyle } from "@/features/test-study/lib/parsePassageTable";
            ...
            return (
              <div
                className={classNames(
                  ...
                  col.border && "border border-border px-1",
