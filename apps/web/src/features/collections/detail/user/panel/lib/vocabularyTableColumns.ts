...
} from "@/features/collections/detail/user/panel/constants/vocabularyTableColumns";
...
export { TABLE_COLUMN_WIDTH as VOCABULARY_TABLE_COLUMN_WIDTH } from "@/features/collections/detail/shared/constants/columnWidths";
