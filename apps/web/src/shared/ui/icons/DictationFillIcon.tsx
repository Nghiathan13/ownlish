...
type DictationFillIconProps = SVGProps<SVGSVGElement>;

export function DictationFillIcon({
  className,
  ...props
}: DictationFillIconProps) {
  return (
    <svg
