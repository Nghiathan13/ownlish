import type { WordsTableHeadColumn } from "./WordsTableHead";
import { WordsTableHead } from "./WordsTableHead";
import { WordsTableDesktopLayout } from "./WordsTableDesktopLayout";
