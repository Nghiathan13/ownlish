...
} from "@/_pages/collections/lib/vocabulary/panel/vocabularyTableRows";
import {
  formatIpaDisplay,
  getIpaFieldValue,
  getSharedIpaUk,
...
} from "@/_pages/collections/lib/vocabulary/panel/vocabularyTableColumns";
import {
  TableBodyState,
  TableMobileState,
  useWordRowHover,
            ...
            return (
              <article
                ...
                className={classNames(
                  "flex min-w-0 flex-col gap-3 rounded-xl border border-border bg-surface-card p-4",
