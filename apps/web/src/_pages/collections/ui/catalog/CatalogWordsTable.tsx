...
import type { CatalogDefinition, CatalogWord } from "@/entities/collection";
import {
  expandCatalogWordsToDefinitionRows,
  type CatalogDefinitionRow,
} from "@/_pages/collections/lib/catalog/catalogTableRows";
import {
  formatIpaDisplay,
  getIpaFieldValue,
  getSharedIpaUk,
...
} from "@/_pages/collections/lib/catalog/catalogTableColumns";
import {
  TABLE_COLUMN_WIDTH,
  TableBodyState,
  TableMobileState,
