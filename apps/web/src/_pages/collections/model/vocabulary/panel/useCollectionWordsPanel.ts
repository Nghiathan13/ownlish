...
import type { VocabWord, VocabWordDefinition } from "@/entities/vocab";
import { useAuthSession, isAuthenticatedStatus } from "@/entities/session";
import { useVocabularyTableColumnVisibility } from "@/_pages/collections/model/vocabulary/panel/useVocabularyTableColumnVisibility";
import { useVocabularyWords } from "@/_pages/collections/model/vocabulary/data/useVocabularyWords";
import {
  getSelectableDefinitions,
  getSelectedDefinitions,
} from "@/_pages/collections/lib/vocabulary/panel/vocabularySelection";
